    ...
    return (
        <div className="relative border-l-2 border-gray-200 pl-8 pb-12">
            <div className="absolute w-4 h-4 bg-blue-500 rounded-full -left-2 top-0" />
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-300 text-left">{experience.title}</h3>
                <p className="text-lg text-blue-600 mb-2 text-left">{experience.company}</p>

                <div className="flex justify-between items-center text-sm text-gray-500 mb-4 dark:text-gray-300">
                ...
                <h4 className="font-semibold text-gray-700 dark:text-gray-300 mt-4 mb-2 text-left">Tecnologias:</h4>
