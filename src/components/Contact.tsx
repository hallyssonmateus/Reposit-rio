    ...
    return (
        <section className="py-20 bg-gray-100 dark:bg-gray-900">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl text-gray-600 dark:text-gray-300 text-bold text-center mb-4">Entre em Contato</h2>
                <p className="text-gray-600 text-center mb-12 dark:text-gray-300">Sinta-se à vontade para me chamar nas redes abaixo!</p>
